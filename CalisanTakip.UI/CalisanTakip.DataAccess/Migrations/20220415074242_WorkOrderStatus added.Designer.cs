...
{
    [DbContext(typeof(CalisanTakipContext))]
    [Migration("20220415074242_WorkOrderStatus added")]
    partial class WorkOrderStatusadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalisanTakip.DataAccess.DbModels.EmployeeLeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CalisanTakip.DataAccess.DbModels.EmployeeLeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CalisanTakip.DataAccess.DbModels.EmployeeLeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CalisanTakip.DataAccess.DbModels.WorkOrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CalisanTakip.DataAccess.DbModels.Employee", b =>
                {
            ...
            modelBuilder.Entity("CalisanTakip.DataAccess.DbModels.EmployeeLeaveAllocation", b =>
                {
                    b.HasOne("CalisanTakip.DataAccess.DbModels.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("CalisanTakip.DataAccess.DbModels.EmployeeLeaveType", "EmployeeLeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("CalisanTakip.DataAccess.DbModels.EmployeeLeaveRequest", b =>
                {
                    b.HasOne("CalisanTakip.DataAccess.DbModels.Employee", "ApprovedEmployee")
                        .WithMany()
